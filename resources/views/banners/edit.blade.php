...
<div class="row">
    ...
    <div class="col-sm-8 offset-sm-2">
       ...
       Heading <input type="text" class="form-control" value="{{$data->heading}}" name="heading"/>
      ...
      <div class="row form-group m-auto col-5">
      Description <input type="text" class="form-control" value="{{$data->description}}" name="description"/>
      ...
      <img src="{{ asset('storage/'.$data->image)}}" width="50px" height="100px">
      @if($errors->has('image'))
      ...
      Status <br> <input type="checkbox" name="status" {{$data->status == '1' ? 'checked':''}}  />  0=visible , 1=hidden
