                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <a href="{{ route('configuration.create')}}"  class="btn btn-info float-right">New configuration</a>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$c->email}}</td>
                                                <td>
                                                    <a href="{{ route('configuration.edit', $c->id)}}" class="btn btn-warning">Edit</a><br><br>
                                                
                                                    <form action="{{ route('configuration.destroy', $c->id)}}" method="post">
                                                        @csrf
                                                        @method('DELETE')
